...
<!-- Float Chart js -->
<script src="{{url('/')}}/assets/js/float/jquery.flot.js"></script>
<script src="{{url('/')}}/assets/js/float/jquery.flot.categories.js"></script>
<script src="{{url('/')}}/assets/js/float/curvedLines.js"></script>
<script src="{{url('/')}}/assets/js/float/jquery.flot.tooltip.min.js"></script>
<!-- amchart js -->
