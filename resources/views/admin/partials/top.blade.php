<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="">
                <img class="img-fluid" src="{{url('/')}}/assets/images/logo-5.png" alt="Theme-Logo" />
            </a>
                ...
                <li class="header-notification">
                    <div class="dropdown-primary dropdown">
                        ...
                        <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            ...
                            <li>
                                <div class="media">
                                    <img class="img-radius" src="{{url('/')}}/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                            ...
                            <li>
                                <div class="media">
                                    <img class="img-radius" src="{{url('/')}}/assets/images/avatar-4.jpg" alt="Generic placeholder image">
